...
INSERT INTO `comments` (`id`, `name`, `email`, `comment`, `image`) VALUES
(1, 'Jason Stuckless', 'jason.stuckless1@ontariotechu.net', 'Sample text comment.', 'Jason.png'),
(3, 'Joe', 'joe@gmail.com', 'Hi there', 'joe.jpg');
